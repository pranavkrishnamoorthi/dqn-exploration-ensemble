...
def get_task_kwargs(task_name, q_func):
    if task_name in ['MsPacman-v0', 'PongNoFrameskip-v4']:
        kwargs = {
    ...
    # TODO: Implement get_task_args for an input task, should look similar to get_env_kwags, except the q_func should be shared across tasks
    #see https://arxiv.org/pdf/1905.02099.pdf Page 3: Improvements to Variational Continual learning for determining optimizer
